  ...
  ],
  {
      ...
      class BaseFilterFrontendModule extends elementorModules.Module {
        ...
        setFilterDataForLoopWidget(e, t, n) {
          ...
          if ("DISABLED" !== o) {
            ...
            (n.filterData.terms = [...new Set([...s, ...i])]),
              (n.filterData.logicalJoin = o);
          }
        ...
        getQueryStringInObjectForm() {
          ...
          for (const t in this.loopWidgetsStore.get()) {
            ...
            for (const s in n.consolidatedFilters) {
              ...
              for (const n in i) {
                const s =
                  a.queryConstants[i[n].logicalJoin ?? "AND"].separator.decoded;
        ...
        updateURLQueryString(e, t) {
          ...
          let o = i.toString();
          (o = o.replace(
            new RegExp(`${a.queryConstants.AND.separator.encoded}`, "g"),
            a.queryConstants.AND.separator.decoded
          )),
            (o = o.replace(
              new RegExp(`${a.queryConstants.OR.separator.encoded}`, "g"),
              a.queryConstants.OR.separator.decoded
            ));
          const r = this.getFilterHelperAttributes(t);
          (o =
            r.pageNum > 1
              ? o
                ? this.formatQueryString(r.baseUrl, o)
                : r.baseUrl
              : o
              ? `?${o}`
              : location.pathname),
      ...
      class TaxonomyFilter extends elementorModules.frontend.handlers.Base {
        ...
        activateFilterButton(e) {
          ...
          i &&
            i.includes(s) &&
            s !== e &&
            this.deactivateDefaultFilterButton(t);
        }
        deactivateFilterButton(e) {
          ...
          s.attr("aria-pressed", !1),
            r && this.activateDefaultFilterButton(),
        ...
        getFilterOperator() {
          const e = this.getElementSettings();
          return e.multiple_selection &&
            ["AND", "OR"].includes(e.logical_combination)
            ? e.logical_combination
            : "DISABLED";
        }
        filterItems(e) {
          const t = this.getElementSettings(),
          ...
          if (n === e)
            return void elementorProFrontend.modules.taxonomyFilter.removeFilterFromLoopWidget(
              t.selected_element,
              this.getID(),
              e,
              n
          ...
          elementorProFrontend.modules.taxonomyFilter.setFilterDataForLoopWidget(
            ...
            {
              filterType: "taxonomy",
              filterData: { selectedTaxonomy: t.taxonomy, terms: [e] },
            },
            !0,
            s
          );
        ...
        userClickedOnAllWhileItWasActive(e, t) {
          return (
            t.includes(e) && e === this.getSettings("filterValues.default")
          );
        }
        onDestroy() {
        ...
        populateLoopWidgetsStoreOnInitialPageLoad() {
          ...
          if (t) {
            ...
            elementorProFrontend.modules.taxonomyFilter.setFilterDataForLoopWidget(
              ...
              {
                filterType: "taxonomy",
                filterData: { selectedTaxonomy: e.taxonomy, terms: t },
              },
              !1,
              n
            );
        ...
        getTermsFromParams(e) {
          ...
          return (
            e.includes(i.queryConstants.OR.separator.fromBrowser) &&
              (t = i.queryConstants.OR.separator.fromBrowser),
            e.split(t)
          );
        }
        onInit() {
        ...
        consolidateFilters(e) {
          ...
          for (const e in t) {
            ...
            0 !== o.terms.length &&
              ...
              !o.terms ||
                (n[i][o.selectedTaxonomy].terms &&
                  n[i][o.selectedTaxonomy].terms.includes(o.terms)) ||
                (n[i][o.selectedTaxonomy] = {
                  terms: "string" === o.terms ? [o.terms] : o.terms,
                }),
              o.logicalJoin &&
                !n[i][o.selectedTaxonomy].logicalJoin &&
                (n[i][o.selectedTaxonomy] = {
                  ...(n[i][o.selectedTaxonomy] || {}),
      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        activateTab(e) {
          const t = this.getSettings(),
            ...
            o = this.elements.$tabDropdowns
              .filter(this.getTabTitleFilterSelector(e))
              .not(s),
            r = "show" === t.showTabFn ? 0 : 400,
            a = this.elements.$tabContents
              .filter(this.getTabContentFilterSelector(e))
              .not(i),
            l = this.elements.$menuContent;
          this.addAnimationToContentIfNeeded(e),
            a[t.showTabFn](r, () => this.onShowTabContent(a)),
            o.attr(this.getTitleActivationAttributes()),
            o
              .prev(".e-n-menu-title-container")
              .find("a")
              .attr(this.getTitleActivationAttributes("link")),
            a.addClass(n),
            a.css({ display: "var(--display)" }),
            a.removeAttr("display"),
            l.addClass(n),
            elementorFrontend.isEditMode() &&
              a.length &&
              this.activeContainerWidthListener(a),
            this.menuHeightController.reassignMenuHeight(a);
        }
        deactivateActiveTab(e) {
          ...
          this.setTabDeactivationAttributes(o, e),
            ...
            this.menuHeightController.resetMenuHeight(r);
        }
        ...
        onTabClick(e) {
          ...
          const t = e?.target
            ?.closest(".elementor-widget-n-menu")
        ...
        resizeEventHandler() {
          ...
          const e = this.getSettings("ariaAttributes").activeTitleSelector,
            ...
            s = this.elements.$tabContents
              .filter(this.getTabContentFilterSelector(t))
              .not(n);
          this.menuHeightController.resetMenuHeight(s),
            this.menuHeightController.reassignMenuHeight(s);
        }
        ...
        isNestedElementRenderedInContentContainer(e) {
          ...
          return t
            .getParentAncestry()
            .some(
              (e) => this.getID().toString() === e.model.get("id").toString()
            );
        }
        getTabEvents() {
        ...
        onInit() {
          ...
          this.menuToggleVisibilityListener(this.elements.$dropdownMenuToggle),
            this.setScrollPosition(),
            (this.onClickOutsideDropdownMenu =
              this.onClickOutsideDropdownMenu.bind(this)),
    ...
    6921: (e, t) => {
      ...
      class MenuTitleKeyboardHandler extends elementorModules.frontend.handlers
        ...
        setTitleTabindex(e) {
          ...
          t.attr("tabindex", "0"),
            t
              .closest(".e-n-menu-title-container")
              .next(".e-n-menu-dropdown-icon")
              .attr("tabindex", "0"),
            t.prev(".e-n-menu-title-container").find("a").attr("tabindex", "0");
        }
    ...
    8496: (e, t, n) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var i = s(n(2298));
      t.default = i.default.extend({ getSkinPrefix: () => "cards_" });
    },
    2607: (e, t) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    9409: (e, t, n) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var i = s(n(8496));
      t.default = i.default.extend({ getSkinPrefix: () => "archive_cards_" });
    },
    8537: (e, t, n) => {
      "use strict";
      var s = n(3203);
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var i = s(n(2298));
      t.default = i.default.extend({ getSkinPrefix: () => "archive_classic_" });
    },
    224: (e, t, n) => {
      "use strict";
      var s = n(3203);
                ...
                if (
                  ...
                  (Le =
                    "ADD_DATA_URI_TAGS" in e
                      ? addToSet(clone(Oe), e.ADD_DATA_URI_TAGS, Ge)
                      : Oe),
                  (Ae =
                  ...
                  e.ADD_URI_SAFE_ATTR && addToSet(Pe, e.ADD_URI_SAFE_ATTR, Ge),
                  e.FORBID_CONTENTS &&
                    (Ae === De && (Ae = clone(Ae)),
